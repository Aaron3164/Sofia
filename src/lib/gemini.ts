...
export async function generateStudyMaterials(
  ...
  const prompts = {
    flashcards: `Crée exactement ${cardCount || 30} flashcards de type Anki à partir de ce texte. Extraie les concepts, détails et définitions les plus importants sans faire de doublons ni de répétitions. 
